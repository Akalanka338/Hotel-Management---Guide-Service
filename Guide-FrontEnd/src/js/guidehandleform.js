...
VehicleAddRequest=()=>{
   ...
   /* const drivername =document.getElementById('txtdrivername0').value;
    ...
    AddVehicleObj(id,brand,category,fueltype,hybridornon,fuelusage,vehicleImg,seatcapacity,vehicletype);
...
sendAjaxVehicleRequest = (addVehicleData) => {
    ...
    $.ajax({
        url: "http://localhost:8060/Mapping/api/guide",
        type: "POST",
        data: addVehicleData,
...
VehicleUpdateRequest=()=>{
    ...
    const drivercontact =document.getElementById('txtdrivercontact0').value;
    const drivernicimg =document.getElementById('txtDriverNicImage0');*/
    updateVehicleObj(id,brand,category,fueltype,hybridornon,fuelusage,vehicleImg,seatcapacity,vehicletype);
...
$("#btnVehicleDelete").click(function () {
    ...
    $.ajax({
        url: "http://localhost:8060/Mapping/api/guide?id="+guideid,
        type:"DELETE",
        dataType: "json",
        success:function (resp){
            alert(resp.message);
